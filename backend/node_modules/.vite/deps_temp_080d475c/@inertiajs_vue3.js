...
function k(t, e, i, n = "brackets") {
  let o = /^https?:\/\//.test(e.toString()), c = o || e.toString().startsWith("/"), h2 = !c && !e.toString().startsWith("#") && !e.toString().startsWith("?"), m2 = e.toString().includes("?") || t === "get" && Object.keys(i).length, b = e.toString().includes("#"), a = new URL(e.toString(), "http://localhost");
  return t === "get" && Object.keys(i).length && (a.search = O.stringify((0, import_deepmerge.default)(O.parse(a.search, { ignoreQueryPrefix: true }), i), { encodeValuesOnly: true, arrayFormat: n }), i = {}), [[o ? `${a.protocol}//${a.host}` : "", c ? a.pathname : "", h2 ? a.pathname.substring(1) : "", m2 ? a.search : "", b ? a.hash : ""].join(""), i];
}
function w(t) {
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h2 = false, only: m2 = [], headers: b = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g2 = () => {
  }, onBefore: L2 = () => {
  }, onStart: d2 = () => {
  }, onProgress: p = () => {
  }, onFinish: T2 = () => {
    ...
    let P = { url: x, method: i, data: n, replace: o, preserveScroll: c, preserveState: h2, only: m2, headers: b, errorBag: a, forceFormData: l, queryStringArrayFormat: F, cancelled: false, completed: false, interrupted: false };
    if (L2(P) === false || !M(P))
      return;
    this.activeVisit && this.cancelVisit(this.activeVisit, { interrupted: true }), this.saveScrollPositions();
    let G = this.createVisitId();
    this.activeVisit = { ...P, onCancelToken: g2, onBefore: L2, onStart: d2, onProgress: p, onFinish: T2, onCancel: y, onSuccess: D, onError: U, queryStringArrayFormat: F, cancelToken: new AbortController() }, g2({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
    } }), W(P), d2(P), axios_default({ method: i, url: w(x).href, data: i === "get" ? {} : n, params: i === "get" ? n : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...b, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...m2.length ? { "X-Inertia-Partial-Component": this.page.component, "X-Inertia-Partial-Data": m2.join(",") } : {}, ...a && a.length ? { "X-Inertia-Error-Bag": a } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (r) => {
      ...
      let E = x, V2 = v(s.url);
      return E.hash && !V2.hash && w(E).href === V2.href && (V2.hash = E.hash, s.url = V2.href), this.setPage(s, { visitId: G, replace: o, preserveScroll: c, preserveState: h2 });
    }).then(() => {
...
function Q(t, e, i) {
  ...
  return a(), { forceUpdate: a, createProvider: function() {
    let l = c();
    return { update: (g2) => m2(l, g2), disconnect: () => h2(l) };
  } };
}
var Y = null;
function ne(t) {
...
function T(e, o) {
  let n = typeof e == "string" ? e : null, p = typeof e == "string" ? o : e, t = n ? Oe.restore(n) : null, a = typeof p == "object" ? (0, import_lodash2.default)(p) : (0, import_lodash2.default)(p()), l = null, f2 = null, h2 = (r) => r, y = reactive({ ...t ? t.data : (0, import_lodash2.default)(a), isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    return r.length === 0 ? (a = i, Object.assign(this, s)) : Object.keys(s).filter((c) => r.includes(c)).forEach((c) => {
      a[c] = i[c], this[c] = s[c];
    }), this;
  }, setError(r, s) {
    ...
    let c = h2(this.data()), b = { ...i, onCancelToken: (u2) => {
      ...
      let R2 = i.onSuccess ? await i.onSuccess(u2) : null;
      return a = (0, import_lodash2.default)(this.data()), this.isDirty = false, R2;
    }, onError: (u2) => {
    ...
    r === "delete" ? Oe.delete(s, { ...b, data: c }) : Oe[r](s, c, b);
  }, get(r, s) {
    this.submit("get", r, s);
  }, post(r, s) {
...
var W2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  m.value = o ? markRaw(o) : null, d.value = e, S2.value = null;
  let a = typeof window > "u";
  return A2 = Q(a, p, t), a || (Oe.init({ initialPage: e, resolveComponent: n, swapComponent: async (l) => {
    m.value = markRaw(l.component), d.value = l.page, S2.value = l.preserveState ? S2.value : Date.now();
  } }), Oe.on("navigate", () => A2.forceUpdate())), () => {
    if (m.value) {
      m.value.inheritAttrs = !!m.value.inheritAttrs;
      let l = h(m.value, { ...d.value.props, key: S2.value });
      return k2.value && (m.value.layout = k2.value, k2.value = null), m.value.layout ? typeof m.value.layout == "function" ? m.value.layout(h, l) : (Array.isArray(m.value.layout) ? m.value.layout : [m.value.layout]).concat(l).reverse().reduce((f2, h2) => (h2.inheritAttrs = !!h2.inheritAttrs, h(h2, { ...d.value.props }, () => f2))) : l;
    }
  };
} });
var I2 = W2;
var $2 = { install(e) {
  Oe.form = T, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => Oe }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => d.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => A2 }), e.mixin(w2);
} };
function K2() {
...
async function j2({ id: e = "app", resolve: o, setup: n, title: p, progress: t = {}, page: a, render: l }) {
  let f2 = typeof window > "u", h2 = f2 ? null : document.getElementById(e), y = a || JSON.parse(h2.dataset.page), r = (c) => Promise.resolve(o(c)).then((b) => b.default || b), s = [], i = await r(y.component).then((c) => n({ el: h2, App: I2, props: { initialPage: y, initialComponent: c, resolveComponent: r, titleCallback: p, onHeadUpdate: f2 ? (b) => s = b : null }, plugin: $2 }));
  if (!f2 && t && Z(t), f2) {
    let c = await l(createSSRApp({ render: () => h("div", { id: e, "data-page": JSON.stringify(y), innerHTML: i ? l(i) : "" }) }));
    return { head: s, body: c };
  }
}
...
function O2(e, o) {
  if (typeof e == "object" && e !== null && e.__rememberable === false)
    return e;
  let n = Oe.restore(o), p = isReactive(e) ? reactive : ref, t = typeof e.__remember == "function" && typeof e.__restore == "function", a = n === void 0 ? e : p(t ? e.__restore(n) : n);
  return watch(a, (l) => {
