...
$dp__cell_border_radius: var(--dp-cell-border-radius, $dp__border_radius) !default; // Specific border radius for the calendar cell
...
$dp__common_padding: var(--dp-common-padding, 10px)  !default;
